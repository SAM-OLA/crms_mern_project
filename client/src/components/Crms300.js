...
const fetchAllData = async () => {
  let response = await (
    await fetch(`http://localhost:5000/crms300data?userid=${userid}`)
  ).json();
  setAllData(response);
};
...
<div className="row">
  <div className="column">
      ...
      <br></br>
        <input type="date" name="startDate" required placeholder="dd-mm-yyyy" value={startDate} onChange={e => setStartDate(e.target.value)} min="1997-01-01" max="2030-12-31"></input>
        <br></br>
      ...
      <br></br>
       <input type="date" name="expiryDate" required placeholder="dd-mm-yyyy" value={expiryDate} onChange={e => setExpiryDate(e.target.value)} min="1997-01-01" max="2030-12-31"></input>
       <br></br>
     ...
     <br></br>
      ...
      <a className='smalladdbtn2' href={`/CRMS300xmlGeneratedSelf?username=${username}&useremail=${useremail}&userstatus=${userstatus}`} target='_blank'>Generate Excel File
      </a>
      </form>
      </div>
  <div className="column">
